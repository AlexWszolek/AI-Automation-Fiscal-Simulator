"""US state name -> FIPS code. Its own module so the compute service (webpayload) can map
states without importing the altair chart builders; charts.py re-exports it."""
